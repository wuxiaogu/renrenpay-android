...
import static wy.experiment.xposed.hook.StrUtils.formatMoneyToYuan;
...
public abstract class HookBase implements IHooker {
    ...
    public static final String RECV_RESULT_TYPE = "result_type";
...
//                            LogUtils.show(e.getMessage());
     ...
     * @return
     */
    public String getRemoteInfoActionType() {
        return "RemoteInfoActionType." + getClass().getSimpleName();
    }
     ...
     * @return
     */
    public String getLocalInfoActionType() {
        return "LocalInfoActionType." + getClass().getSimpleName();
    }
